...
INSERT INTO integrante (id, rol_id, rol_lacis_id, rol_software_id, activo, nombre, apellido, titulo_especializacion, descripcion, contacto_mail, contacto_linkedin, imagen_url, cv_url, pertenece_lacis, pertenece_grupo_software) VALUES (1, 1, NULL, 1, TRUE, 'Dr. Montegano', 'German', 'Ingenieria de Software', 'Doctor en Ingenieria de Software, Investigador categoría 1', 'german.a.montejano@gmail.com', '', '../../static/assets/img-GIS/IMGintegrantes/Foto German - German A Montejano.jpg', '../../static/assets/CVs-GIS/Bio Germán Montejano-CV resumido - German A Montejano.pdf', FALSE, TRUE);
...
INSERT INTO integrante (id, rol_id, rol_lacis_id, rol_software_id, activo, nombre, apellido, titulo_especializacion, descripcion, contacto_mail, contacto_linkedin, imagen_url, cv_url, pertenece_lacis, pertenece_grupo_software) VALUES (38, 1, 1, NULL, TRUE, 'Test', 'Integracion', 'Testing', 'Prueba E2E', 'test@unsl.edu.ar', '', '', '', TRUE, FALSE);
